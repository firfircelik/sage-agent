...
class GLMProvider(LLMProvider):
    ...
    def __init__(self, api_key: Optional[str] = None, model: str = "glm-4"):
        try:
            ...
            raise ImportError("Zhipu library not installed. Install with: pip install zhipuai")
...
class OpenCodeProvider(LLMProvider):
    ...
    def generate(self, prompt: str, system_prompt: str = "") -> str:
        ...
        try:
            ...
            cmd = f'opencode run "{full_prompt}"'
            if self.model != "auto":
...
class LLMFactory:
    ...
    def get_default() -> Optional[LLMProvider]:
        ...
        try:
            ...
            print("💡 Tip: Set OPENAI_API_KEY or ANTHROPIC_API_KEY environment variable")
            return None
