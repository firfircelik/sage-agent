...
class ContextRetriever:
    ...
    def retrieve_relevant_context(self, query: str, top_k: int = 3, strategy: str = "hybrid") -> str:
        """
...
class RLMOptimizer:
    ...
    def optimize_prompt(
        ...
        if use_cache:
            ...
            if cached:
                ...
                return {
                    ...
                    "context": "",
                    "tokens_original": self.token_counter.count_tokens(query, self.token_method),
                    "tokens_optimized": 0,
        ...
        if self.enable_compression:
            ...
            compressed_tokens = self.token_counter.count_tokens(compressed, self.token_method)
        ...
        original_tokens = self.token_counter.count_tokens(original_query, self.token_method)
        optimized_tokens = self.token_counter.count_tokens(query + context, self.token_method)
